<?php /* Smarty version 2.6.25, created on 2011-05-19 10:23:33
...
function grafChange() {
	grafdata.empty();
	if($(".checkGraf1").attr(\'checked\')){grafdata.push({color:\'#FF0000\',label: \''; ?>
<?php echo $this->_tpl_vars['text65']; ?>
<?php echo '\', data:grafTemp })};
	if($(".checkGraf2").attr(\'checked\')){grafdata.push({color:\'#00FFFF\',label: \''; ?>
<?php echo $this->_tpl_vars['text126']; ?>
<?php echo '\',data:grafFtemp })};
	if($(".checkGraf3").attr(\'checked\')){grafdata.push({color:\'#0000FF\',label: \''; ?>
<?php echo $this->_tpl_vars['text127']; ?>
<?php echo '\',data:grafLight})};
	if($(".checkGraf4").attr(\'checked\')){grafdata.push({color:\'#800080\',label: \''; ?>
<?php echo $this->_tpl_vars['text128']; ?>
<?php echo '\',data:grafFlight })};
	if($(".checkGraf5").attr(\'checked\')){grafdata.push({color:\'#00FF00\',label: \''; ?>
<?php echo $this->_tpl_vars['text129']; ?>
<?php echo '\',data:grafFan_out})};
	if($(".checkGraf6").attr(\'checked\')){grafdata.push({color:\'#FF8040\',label: \''; ?>
<?php echo $this->_tpl_vars['text130']; ?>
<?php echo '\', data:grafFanrpm})};
	if($(".checkGraf7").attr(\'checked\')){grafdata.push({color:\'#FF9900\',label: \''; ?>
<?php echo $this->_tpl_vars['text131']; ?>
<?php echo '\',data:grafRef_input })};
...
:</b></td><td></td></tr>	
		<tr style="text-align:center;">
			<td colspan="2"><textarea  readonly="readonly" class="akutalC" rows="15" cols="70"><?php echo $this->_tpl_vars['report']->usedController; ?>
</textarea></td></tr>
		<tr><td align="center">
		  <table>
			<tr><td><input type="radio" name="contCheck" class="usedC" value="usedC" checked="checked" /><?php echo $this->_tpl_vars['text63']; ?>
</td>
...
<fieldset>
	...
	<table align="center" cellpadding="10px">
		<tr>
			<td>
				<a href="index.php?page=8"><img height="32" src="pic/backIcon.png"  alt="back" /><br /><?php echo $this->_tpl_vars['text81']; ?>
</a>
			</td>
			<td>
