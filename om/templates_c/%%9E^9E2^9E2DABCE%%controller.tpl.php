<?php /* Smarty version 2.6.25, created on 2011-05-07 10:16:40
...
///////////////////////////////////////////////////////////////SAVE BTN///////////////////////////////////////////////////////////////	
	$(\'.saveModel\').click(function(){
		if(isValid() == true) {	
			...
			var dataT = \'\';
			dataT += \'saving=true\';
			dataT += \'&option=\'+encodeURIComponent("'; ?>
...
<?php echo '");
			...
			if($(\'.contId\').length >0){
				dataT += \'&userId=\'+encodeURIComponent("'; ?>
<?php echo $this->_tpl_vars['controller']->login; ?>
<?php echo '");
...
<div class="loadedCont">
	...
	<input type='hidden' name ='parameter' class='parameter' value='<?php echo $this->_tpl_vars['controller']->parameter; ?>
'/>
	<input type='hidden' name ='variable' class='variable' value='<?php echo $this->_tpl_vars['controller']->variable; ?>
'/>	
 	<input type='hidden' name='contId' class='contId' value='<?php echo $this->_tpl_vars['controller']->id; ?>
' />
...
;"><hr />
		...
		<div style="float:right;width:70%;"><textarea  name="equation" class="equation" rows="8" cols="50"><?php echo $this->_tpl_vars['controller']->equation; ?>
</textarea></div>
		<div style="clear:both;" ></div>
	</div>
	<hr />
...
<br />
	<fieldset>
		...
		<table align="center" cellpadding="20">
			<tr>
				<td><a  href="index.php?page=2"><img height="32" src="pic/backIcon.png"  alt="backBtn" /><br /><?php echo $this->_tpl_vars['text81']; ?>
</a></td>
