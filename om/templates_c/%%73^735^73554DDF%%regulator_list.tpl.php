<?php /* Smarty version 2.6.25, created on 2011-05-03 17:19:29
         compiled from regulator_list.tpl */ ?>
...
"><td><?php echo $this->_tpl_vars['default']->id; ?>
				...
				<?php endif; ?>
					<td>
					<a href="index.php?page=2&amp;default=true&amp;show=<?php echo $this->_tpl_vars['default']->id; ?>
" >
						<img src="pic/changeIcon2.png" width="22" alt="edit" />
						</a>
					</td>
					<td>
						<a href="index.php?page=3&amp;simCont=<?php echo $this->_tpl_vars['default']->id; ?>
" >
			...
			<?php if ($this->_tpl_vars['user'] && $this->_tpl_vars['user']->permission < 2): ?>
				<tr><td colspan="6" style="text-align:center;" ><br />
					<a href="index.php?page=2&amp;addNew=true" >
		...
		<div class="userDef" style="display:none;">
			...
			<?php endif; ?>
				<td colspan="2"><?php echo $this->_tpl_vars['text82']; ?>
</td>
			</tr>
...
" >
					...
					<?php endif; ?>
						<td>
							<a href="index.php?page=2&amp;default=false&amp;show=<?php echo $this->_tpl_vars['userDef']->id; ?>
" >
							<img src="pic/startIcon.png" width="22" alt="load" />
							</a>
						</td>
						<td>
							<a href="#">
				...
				<?php endforeach; endif; unset($_from); ?>
			<?php else: ?>
				<tr><td colspan="5" align="center"><?php echo $this->_tpl_vars['text89']; ?>
</td></tr>
			<?php endif; ?>
